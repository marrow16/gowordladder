...
var helpText = helpData{
	...
	},
	{
		...
		[]helpLine{
			...
			{key("F1    "), text(" - to show this help screen.")},
			{key("ctrl+t"), text(" - to show the high scores table.")},
			{key("ctrl+w"), text(" - to lookup the meaning of a word.")},
			{key("ctrl+g"), text(" - to navigate to Generate Screen.")},
			{key("ctrl+s"), text(" - to navigate to Solver Screen.")},
			{key("esc   "), text(" - to exit the app.")},
		},
	},
	{
		"Play Screen",
		[]helpLine{
			...
			{},
			{text("Hint keys:")},
			{key("ctrl+h"), text(" - to show all possible solutions.")},
			{key("ctrl+f"), text(" - to fill in the word for you.")},
	...
	},
	{
		...
		[]helpLine{
			...
			{text("Once the puzzle has been successfully generated, press"), key(" ctrl+p"), text(" to play the puzzle. You can also press"), key(" enter"), text(" to show all possible solutions for the generated puzzle.")},
		},
	},
	{
		"Solver Screen",
		[]helpLine{
			...
			{text("Once the puzzle has been successfully solved, press"), key(" ctrl+p"), text(" to play the puzzle. You can also press"), key(" enter"), text(" to show all possible solutions.")},
		},
	},
	{
		"About",
